  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        sos: "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-[0_0_30px_-5px_hsl(var(--destructive)/0.4)] animate-[sos-pulse_2s_cubic-bezier(0.4,0,0.6,1)_infinite] font-bold uppercase tracking-wider",
        ...
        critical: "bg-critical text-critical-foreground hover:bg-critical/90 animate-[alert-flash_1s_ease-in-out_infinite] shadow-[0_0_30px_-5px_hsl(var(--destructive)/0.4)]",
      },
      size: {
